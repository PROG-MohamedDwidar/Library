...
public abstract class db_login_connect {
	...
	static void checkpass(ObjectOutputStream out, ObjectInputStream in) throws IOException, ClassNotFoundException {
	...
	/*String name*/
	static void getid(ObjectOutputStream out, ObjectInputStream in) throws SQLException, IOException, ClassNotFoundException {
		String name = (String)in.readObject();
		try {
